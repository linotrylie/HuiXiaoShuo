...
use support\HuiModelBuilder as Builder;
 ...
 * @method static \support\HuiModelBuilder withGlobalScope($identifier, $scope)
 * @method static \support\HuiModelBuilder withoutGlobalScope($scope)
 * @method static \support\HuiModelBuilder withoutGlobalScopes($scopes = null)
 * @method static array removedScopes()
 * @method static \support\HuiModelBuilder whereKey($id)
 * @method static \support\HuiModelBuilder whereKeyNot($id)
 * @method static \support\HuiModelBuilder where($column, $operator = null, $value = null, $boolean = 'and')
 * @method static BaseModel|null firstWhere($column, $operator = null, $value = null, $boolean = 'and')
 * @method static \support\HuiModelBuilder orWhere($column, $operator = null, $value = null)
 * @method static \support\HuiModelBuilder latest($column = null)
 * @method static \support\HuiModelBuilder oldest($column = null)
 ...
 * @method static \support\HuiModelBuilder without($relations)
 * @method static \support\HuiModelBuilder withOnly($relations)
 * @method static BaseModel newModelInstance($attributes = [])
 * @method static \support\HuiModelBuilder withCasts($casts)
 * @method static Builder getQuery()
 * @method static \support\HuiModelBuilder setQuery($query)
 * @method static Builder toBase()
 * @method static array getEagerLoads()
 * @method static \support\HuiModelBuilder setEagerLoads($eagerLoad)
 * @method static BaseModel getModel()
 * @method static \support\HuiModelBuilder setModel($model)
 ...
 * @method static \support\HuiModelBuilder has($relation, $operator = '>=', $count = 1, $boolean = 'and', $callback = null)
 * @method static \support\HuiModelBuilder orHas($relation, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder doesntHave($relation, $boolean = 'and', $callback = null)
 * @method static \support\HuiModelBuilder orDoesntHave($relation)
 * @method static \support\HuiModelBuilder whereHas($relation, $callback = null, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder orWhereHas($relation, $callback = null, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder whereDoesntHave($relation, $callback = null)
 * @method static \support\HuiModelBuilder orWhereDoesntHave($relation, $callback = null)
 * @method static \support\HuiModelBuilder hasMorph($relation, $types, $operator = '>=', $count = 1, $boolean = 'and', $callback = null)
 * @method static \support\HuiModelBuilder orHasMorph($relation, $types, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder doesntHaveMorph($relation, $types, $boolean = 'and', $callback = null)
 * @method static \support\HuiModelBuilder orDoesntHaveMorph($relation, $types)
 * @method static \support\HuiModelBuilder whereHasMorph($relation, $types, $callback = null, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder orWhereHasMorph($relation, $types, $callback = null, $operator = '>=', $count = 1)
 * @method static \support\HuiModelBuilder whereDoesntHaveMorph($relation, $types, $callback = null)
 * @method static \support\HuiModelBuilder orWhereDoesntHaveMorph($relation, $types, $callback = null)
 * @method static \support\HuiModelBuilder withAggregate($relations, $column, $function = null)
 * @method static \support\HuiModelBuilder withCount($relations)
 * @method static \support\HuiModelBuilder withMax($relation, $column)
 * @method static \support\HuiModelBuilder withMin($relation, $column)
 * @method static \support\HuiModelBuilder withSum($relation, $column)
 * @method static \support\HuiModelBuilder withAvg($relation, $column)
 * @method static \support\HuiModelBuilder withExists($relation)
 * @method static \support\HuiModelBuilder mergeConstraintsFrom($from)
 ...
 * @method static \support\HuiModelBuilder tap($callback)
 ...
 */
class HuiModel extends BaseModel
{
